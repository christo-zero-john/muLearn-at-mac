!function(t, e) {
   "object" == typeof exports && "undefined" != typeof module ? module.exports = e(require("cross-fetch")) : "function" == typeof define && define.amd ? define(["cross-fetch"], e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).sheetrock = e(t.fetch)
}(this, (function(t) {
   "use strict";
   function e(t) {
   ...
   function l(t) {
       const e = t.num ? "td" : "th";
       let s = "";
       return Object.keys(t.cells).forEach((r=>{
           s += a(t.cells[r], e)
       }
       )),
       a(s, "tr")
   ...
   class c {
       constructor(t={}, e=!1) {
           this.user = function(t) {
               const e = {};
               if (e.target = function(t) {
                   let e = t;
                   return "object" == typeof e && e.jquery && e.length && ([e] = e),
   ...
   class d {
       constructor(t) {
           ...
           if (this.state.loaded)
               throw new u("No more rows to load!")
       }
       get state() {
           ...
           if (!t || e) {
               const e = {
                   labels: t ? h.store[this.index].labels : null
               };
               h.store[this.index] = {
                   ...h.defaults,
                   ...e
   ...
   class f {
       constructor(t, e, s) {
           this.num = t,
           this.cellsArray = e.map(i),
           this.labels = s
       }
       get cells() {
           const t = {};
           return this.labels.forEach(((e,s)=>{
   ...
   class p {
       ...
       setAttributes() {
           ...
           this.request.state.offset || (o = s.map(((t,s)=>t.label ? t.label.replace(/\s/g, "") : (r.last += 1,
           r.rowNumberOffset = 1,
           i(e[0].c[s]) || t.id))),
           this.request.update({
           ...
           (!t || e.length - r.rowNumberOffset < t) && (r.last += 1,
           this.request.update({
               loaded: !0
           }));
   ...
   function b(t={}, e=null) {
       ...
       return e ? n.loadData(e, i) : r && o && n && ("object" == typeof window && "document"in window ? function(t, e) {
           ...
           ,
           r.addEventListener && (r.addEventListener("error", i, !1),
  ...
  */
       (n, i) : function(t, e) {
           s.default(t.request.url, {
               ...
               if (!t.ok)
                   throw new u("Request failed.",t.status);
               return t.text()
           }
           )).then((s=>{
